...
public class exercise1 {
	...
	public static void main(String[] args) {
		...
		if (skillLevel > 0 && skillLevel < 4) {
			...
			System.out.println("Hourly pay rate: RM" + hourlyPay);
			System.out.println("Regular pay for 40 hours: RM" + regularPay);
			...
			if (itemizedDeductions > totalPay) {
				...
				System.out.println("Total itemized deductions: RM" + itemizedDeductions);
